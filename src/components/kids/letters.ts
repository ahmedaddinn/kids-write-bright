...
export const LETTERS: Record<string, LetterSpec> = {
  ...
  qaf: {
    ...
    viewBox: "0 0 325 595",
    strokes: [
      // One continuous spiral, matching the worksheet's broad bowl and round head.
      "M55 264 C 27 311, 31 383, 72 426 C 111 467, 187 476, 241 443 C 296 409, 313 341, 294 273 C 278 215, 250 181, 207 180 C 160 179, 130 216, 132 263 C 134 310, 166 338, 207 338 C 245 338, 270 314, 273 281",
      // Small teardrop opening inside the head.
      "M205 237 C 232 241, 244 266, 240 289 C 220 302, 191 298, 180 286 C 180 262, 190 243, 205 237",
    ],
    widths: [42, 20],
    dots: [
      { cx: 170, cy: 125 },
  ...
  hah: {
    ...
    viewBox: "0 0 361 587",
    strokes: [
      // Upright oval loop, beginning at its lower-left join.
      "M150 364 C 127 321, 133 259, 166 226 C 202 191, 258 207, 288 251 C 319 297, 311 354, 276 381 C 236 411, 177 404, 150 364",
      // Long pointed base: out to the left, then back beneath the loop.
      "M276 381 C 218 387, 132 397, 47 412 C 82 449, 174 451, 303 425",
    ],
    widths: [38, 30],
  },
  waw: {
    ...
    viewBox: "0 0 273 594",
    strokes: [
      // Continuous spiral and descending tail from the worksheet.
      "M78 470 C 43 478, 19 457, 29 427 C 39 397, 70 386, 104 379 C 158 368, 188 337, 204 294 C 224 240, 219 178, 176 154 C 134 130, 78 147, 55 192 C 28 245, 57 301, 111 316 C 151 327, 188 311, 207 285",
      // Small teardrop opening inside the round head.
      "M138 211 C 162 216, 176 239, 173 260 C 153 273, 124 268, 113 256 C 112 233, 122 216, 138 211",
    ],
    widths: [40, 20],
  },
  yaa: {
