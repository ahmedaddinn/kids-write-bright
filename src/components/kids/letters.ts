...
export const LETTERS: Record<string, LetterSpec> = {
  ...
  qaf: {
    ...
    strokes: [
      ...
      "M58 276 C 31 323, 37 398, 79 439 C 119 478, 190 484, 240 452 C 291 419, 310 349, 292 281 C 277 222, 250 183, 207 181 C 160 179, 130 216, 132 263 C 134 310, 166 338, 207 338 C 245 338, 270 314, 273 281",
  ...
  waw: {
    ...
    strokes: [
      ...
      "M92 474 C 59 479, 39 458, 47 432 C 56 404, 82 392, 111 386 C 162 376, 190 345, 202 302 C 218 247, 210 187, 172 166 C 135 145, 91 163, 75 199 C 56 242, 78 288, 119 302 C 151 313, 181 304, 199 286",
